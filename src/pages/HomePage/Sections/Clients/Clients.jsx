...
const Clients = () => {
  ...
  <div className="logo-slider">
    <div className="logo-track">
      {/* <!-- Logos (Set 1) --> */}
      <div className='logo'><img src="HomePage/Clients/logosCompanies/accenture.png" alt="accenture" /></div>
      <div className='logo'><img src="HomePage/Clients/logosCompanies/Atos.webp" alt="Atos" /></div>
      <div className='logo'><img src="HomePage/Clients/logosCompanies/bajafin.png" alt="bajafin" /></div>
      <div className='logo'><img src="HomePage/Clients/logosCompanies/barklays.png" alt="barklays" /></div>
      <div className='logo'><img src="HomePage/Clients/logosCompanies/Endurance.png" alt="Endurance" /></div>
      <div className='logo'><img src="HomePage/Clients/logosCompanies/greenpack.png" alt="greenpack" /></div>
      <div className='logo'><img src="HomePage/Clients/logosCompanies/Microsoft.png" alt="Microsoft" /></div>
      <div className='logo'><img src="HomePage/Clients/logosCompanies/skoda.png" alt="skoda" /></div>
      <div className='logo'><img src="HomePage/Clients/logosCompanies/tvs.png" alt="tvs" /></div>
      <div className='logo'><img src="HomePage/Clients/logosCompanies/teamlease-services.png" alt="teamlease-services" /></div>
